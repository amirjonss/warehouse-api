...
class UpdateApiTest extends BaseApiTestCase
{
    public function testSuccessUpdateActualQty(): void
    {
        ...
        $itemIri = $this->line($client, '50.000');

        $data = $this->patch($client, $itemIri, '45.000')->toArray();
    ...
    public function testSuccessUpdateDoesNotMoveTheExpectedSnapshot(): void
    {
        ...
        $data = $this->patch($this->createSalesClientWithCredentials(), $itemIri, '40.000')->toArray();
    ...
    public function testIncorrectUpdateItemOfPostedInventory(): void
    {
        ...
        $this->patch($this->createSalesClientWithCredentials(), $item['@id'], '45.000');
    ...
    {
        $foreignItemIri = $this->line($this->createSecondSalesClientWithCredentials(), '50.000');

        $this->patch($this->createSalesClientWithCredentials(), $foreignItemIri, '45.000');
