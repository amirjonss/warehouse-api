    ...
    PasswordAuthenticatedUserInterface
{
    ...
    #[Groups(['users:read', 'receipts:read', 'sales:read', 'writeoffs:read', 'payments:read', 'expenses:read', 'exchange-rates:read', 'cash-session:read', 'cash-entry:read', 'inventories:read'])]
    private ?int $id = null;
    ...
    #[Groups(['users:read', 'user:write', 'user:put:write', 'user:create:write', 'receipts:read', 'sales:read', 'writeoffs:read', 'payments:read', 'expenses:read', 'exchange-rates:read', 'cash-session:read', 'cash-entry:read', 'inventories:read'])]
